...
/**
 * Criteria class for the {@link com.apptium.order.domain.OrdAcquisitionChar} entity. This class is used
 * in {@link com.apptium.order.web.rest.OrdAcquisitionCharResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /ord-acquisition-chars?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class OrdAcquisitionCharCriteria implements Serializable, Criteria {
    ...
    public OrdAcquisitionCharCriteria() {}

    public OrdAcquisitionCharCriteria(OrdAcquisitionCharCriteria other) {
    ...
    @Override
    public OrdAcquisitionCharCriteria copy() {
        return new OrdAcquisitionCharCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final OrdAcquisitionCharCriteria that = (OrdAcquisitionCharCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, value, valueType, createdBy, createdDate, ordAcquisitionId);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "OrdAcquisitionCharCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            (name != null ? "name=" + name + ", " : "") +
